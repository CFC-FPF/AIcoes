...
async function startServer() {
    const { default: stocksRouter } = await Promise.resolve().then(() => __importStar(require('./routes/stocks.js')));
    const { testConnection } = await Promise.resolve().then(() => __importStar(require('./lib/supabase.js')));
